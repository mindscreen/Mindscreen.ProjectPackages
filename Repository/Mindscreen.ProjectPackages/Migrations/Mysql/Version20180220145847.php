 ...
 */
class Version20180220145847 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE mindscreen_projectpackages_domain_model_package ADD requiredby VARCHAR(40) DEFAULT NULL, ADD depth INT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE mindscreen_projectpackages_domain_model_package DROP requiredby, DROP depth');
    }
}